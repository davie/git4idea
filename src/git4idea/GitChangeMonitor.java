...
//                final LocalChangeList gitList = changeListManager.getDefaultChangeList();
//                if (gitList.isReadOnly())
//                    gitList.setReadOnly(false);
//                final Change[] gc = newChanges.toArray( new Change[ newChanges.size() ] );
//
//                changeListManager.moveChangesTo(gitList, gc);
